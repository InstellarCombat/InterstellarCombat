...
public class HelloCollision extends SimpleApplication
  ...
  private boolean left = false, right = false, forward = false, back = false, up = false, down = false;
  ...
  public void simpleInitApp() {
    ...
    viewPort.setBackgroundColor(new ColorRGBA(0f, 0f, 0f, 0.2f));
  ...
  @Override
    public void simpleUpdate(float tpf) {
        ...
        camUp.set(cam.getUp()).multLocal(0.5f);
